...
const heroContent = {
    intro: {
        ...
        subTitle: "Welcome",
        description: "Welcome to a world where creativity meets unwavering structural integrity. At arcraft, we believe that exceptional design goes hand in ahnd with meticulous engineering.",
        btn: {
            href: "/projects",
            label: "View Projects"
        }
            ...
            <div className='lg:flex w-full lg:w-10/12 mx-auto h-auto lg:h-screen lg:min-h-[700px] items-center justify-between'>
                <div className='lg:w-4/12 z-[3] relative'>
                    ...
                    >
                        ...
                        className='transition-all duration-300 ease-in-out text-[11.5px] tracking-[2px] font-bold uppercaase bg-violet-600 py-4 px-5 text-white inline-block hover:bg-white hover:text-violet-600 hover:shadow-2xl'>
                            {heroContent.intro.btn.label}
                        </Link>
                    </motion.p>
                    )}
